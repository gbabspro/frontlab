...
import {SetRinging} from "../../../redux/actions/call/callAction"; 
import {store} from "../../../redux/storeConfig/store"
import {setDialog} from "../../../redux/actions/dialog/dialogActions";
import {setCallState} from "../../../redux/actions/state/stateAction";
...
export default class VertoDialog {
	...
	setState(state) {
		...
		console.log("Verto.enum.state.ringing ", Verto.enum.state.ringing)
		...
		store.dispatch(setCallState(dialog.state.name));
		return true;
	}
	...
	answer(params) {
		...
		console.log("dialog params paramas params : ", dialog)
